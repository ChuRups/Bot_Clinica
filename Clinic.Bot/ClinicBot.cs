...
namespace Clinic.Bot
{
    public class ClinicBot<T> : ActivityHandler where T : Dialog
    {
        ...
        private async Task SaveUser(ITurnContext<IMessageActivity> turnContext)
        {
            ...
            userModel.registerDate = DateTime.UtcNow.AddHours(-5).Date;
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            await _dialog.RunAsync(turnContext, _conversationState.CreateProperty<DialogState>(nameof(DialogState)), cancellationToken); //redirigir a mi diálogo
        }
    }
}
